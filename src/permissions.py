...
class PermissionResult:
    ...
    def __init__(self, allowed: bool, message: str = "", updated_input: dict | None = None):
...
def get_allowed_patterns(preset: PermissionPreset, custom_rules: list[str] | None = None) -> list[str]:
...
async def create_permission_handler(
    ...
    async def handler(tool_name: str, input_data: dict, context: dict) -> PermissionResult:
...
def is_tool_allowed(tool_name: str, preset: PermissionPreset, custom_rules: list[str] | None = None) -> bool:
